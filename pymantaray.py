...
class MantarayIndexHTMLGenerator:
    ...
    def generate(self):
        ...
        with open(self.output_html_path, 'w') as f:
            ...
            f.write('  <img src="https://gateway.fairdatasociety.org/bzz/d17f23bb8b35557092f69f821ad71f0e33a4fdaab234684eee0b8680f5f7ea37/" alt="Loading..." />\n')
            f.write('</div>\n')
            ...
            f.write('      viewer.document.body.style.background = "#000 url(\'https://gateway.fairdatasociety.org/bzz/7c824651b2d82281944830fc0b261f10d26dbbd5b24efa8f030f55d8e5c2e1ef/\') repeat center center scroll";\n')
