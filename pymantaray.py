...
class MantarayIndexHTMLGenerator:
    ...
    def generate(self):
        ...
        with open(self.output_html_path, 'w') as f:
            ...
            f.write('<style>\n')
            f.write('body {\n')
            f.write('  background: #000 url("https://gateway.fairdatasociety.org/bzz/b7836cce28a57987d338e5dfb5a2c88ba5075eba94a02194389e91759cfc60a7/") repeat center center scroll;\n')
            ...
            f.write('        "#000 url(\'https://gateway.fairdatasociety.org/bzz/b7836cce28a57987d338e5dfb5a2c88ba5075eba94a02194389e91759cfc60a7/\') repeat center center scroll";\n')
            ...
            f.write('    indexContainer.style.background = "#000 url(\'https://gateway.fairdatasociety.org/bzz/b7836cce28a57987d338e5dfb5a2c88ba5075eba94a02194389e91759cfc60a7/\') repeat center center scroll";\n')
