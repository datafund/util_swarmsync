...
class MantarayIndexHTMLGenerator:
    ...
    def generate(self):
        ...
        with open(self.output_html_path, 'w') as f:
            ...
            f.write('<style>\n')
            f.write('body {\n')
            f.write('  background: #000 url("https://gateway.fairdatasociety.org/bzz/303b101e723bf1549cbe1434214617180e23627c240363e8cb63761f5fa8e0e4/") repeat center center scroll;\n')
            ...
            f.write('        "#000 url(\'https://gateway.fairdatasociety.org/bzz/303b101e723bf1549cbe1434214617180e23627c240363e8cb63761f5fa8e0e4/\') repeat center center scroll";\n')
            ...
            f.write('    indexContainer.style.background = "#000 url(\'https://gateway.fairdatasociety.org/bzz/303b101e723bf1549cbe1434214617180e23627c240363e8cb63761f5fa8e0e4/\') repeat center center scroll";\n')
